    ...
    <Dialog>
      ...
      <DialogContent className="bg-gray-100 ">
        <DialogHeader>
          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm sm:text-xs sm:flex sm:flex-wrap sm:justify-center">
        ...
        <DialogFooter className="text-xs text-gray-500 mt-4 text-center mx-auto">
          <span className="inline-flex items-center">
            Crafted by
            <Link href="https://www.linkedin.com/in/sofyanegi/" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline mx-1 font-bold" aria-label="Support Sofyanegi on Saweria">
              Sofyanegi
            </Link>
          </span>
        </DialogFooter>
